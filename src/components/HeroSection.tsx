      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 lg:space-y-8 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            ...
            <p style={{
            animationDelay: "0.2s"
          }} className="max-w-lg animate-fade-in text-2xl text-[#5c527a]">Curb healthcare costs with ONE platform. Manage GLP-1/Obesity, Diabetes, Digestive, Heart Health, and Autoimmune .</p>
